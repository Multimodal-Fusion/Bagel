...
# Visual Jigsaw 3x3 Position Training Script
# This script trains Bagel on the 3x3 visual jigsaw position dataset
...
# experiment config
########################################################
export DATASET_CONFIG="$MAIN_DIR/data/configs/visual_jigsaw_3x3_position.yaml"
export MODEL_PATH="$MAIN_DIR/models/BAGEL-7B-MoT"

export EXPERIMENT_NAME="bagel-vlm-visual-jigsaw-3x3-position-360k-sft-v1"
...
########################################################
echo "=========================================="
echo "Visual Jigsaw 3x3 Position Training"
echo "=========================================="
...
echo "Dataset size: 360k samples"
echo "=========================================="
